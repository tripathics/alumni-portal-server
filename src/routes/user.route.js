...
import {
  login, register, readProfile, updateProfile, getProfileCompletionStatus, logout, updateAvatar,
  checkEmailNotExists, readUser, checkEmailExists, updatePassword, validateSession,
} from '../controllers/user.controller.js';
import {
  createUpdateEducation, deleteEducation, getEducationsAtNitap, getEducations,
...
router.get('/profile-completion-status', authenticate, getProfileCompletionStatus);
...
router.post('/education', authenticate, ensureProfileUnlocked, createUpdateEducation);
router.delete('/education', authenticate, ensureProfileUnlocked, deleteEducation);

router.get('/experience', authenticate, getExperiences);
router.post('/experience', authenticate, ensureProfileUnlocked, createUpdateExperience);
router.delete('/experience', authenticate, ensureProfileUnlocked, deleteExperience);
